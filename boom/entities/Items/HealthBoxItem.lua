...
local createHealthBoxItem = function(x, y, r, world, light_world)
    local e = Entity()
    local image = AssetsManager:instance().images.item_health_box
