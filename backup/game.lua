...
local input_handler = require("boom.control.input_handler")
local tank_manager = require("boom.entity.tank_manager")
local cockpit = require("boom.UI.cockpit")
local mapcoll_manager = require("boom.system.mapcoll_manager")
local maptool_manager = require("boom.system.maptool_manager")
local Shader = require("boom.system.shader")
...
function game:update(dt)
  ...
  if first_time_to_update then
    ...
    game_thread = love.thread.newThread("boom/system/game_thread.lua")
